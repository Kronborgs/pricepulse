...
pathlib.Path(r"c:\Users\Kronborgs_LabPC\pricepulse\frontend\src\components\dashboard\stats-row.tsx").write_text(stats_row, encoding="utf-8")
print("stats-row.tsx written")
